...
import app.spidy.tamilmemecreator.adapters.ToolAdapter
import app.spidy.tamilmemecreator.data.SavedMeme
import app.spidy.tamilmemecreator.data.Tool
import app.spidy.tamilmemecreator.databases.MemeDatabase
import app.spidy.tamilmemecreator.fragments.EmojiesBottomSheetFragment
import app.spidy.tamilmemecreator.interfaces.EditorListener
import app.spidy.tamilmemecreator.utils.*
import java.io.File
...
class EditorActivity : AppCompatActivity() {
    ...
    private val defaultTools = listOf(
        Tool(Tool.EDITOR_IMAGE, "Image", R.drawable.ic_background_image_picker),
        Tool(Tool.EDITOR_BACKGROUND_COLOR, "Background Color", R.drawable.ic_background_picker),
    ...
    private val textTools = listOf(
        ...
        Tool(Tool.TEXT_COLOR, "Color", R.drawable.ic_color_picker),
...
//        editorView.source?.setImageBitmap(Bitmap.createScaledBitmap(bitmap, 1024, 720, false))
        ...
        editorView.source?.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.placeholder))
        ...
        editor.addImage(ContextCompat.getDrawable(this, R.drawable.logo)!!.toBitmap())
