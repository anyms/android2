...
def fetch_podcast():
    ...
    counter = 0
    while True:
        url = 'https://listen-api.listennotes.com/api/v2/search?q=cybersecurity&sort_by_date=0&type=podcast&offset={}&len_min=1&len_max=300&published_before={}&published_after=0&only_in=title%2Cdescription&language=English&safe_mode=0'.format(offset, time.time() * 1000)
        headers = {
