...
import app.spidy.oli.BuildConfig
import app.spidy.oli.R
import app.spidy.oli.data.Episode
import app.spidy.oli.fragments.DownloadFragment
import app.spidy.oli.fragments.HomeFragment
import app.spidy.oli.fragments.RecentFragment
...
//            playBtn.visibility = if (playbackState == Player.STATE_BUFFERING) { View.GONE } else { View.VISIBLE }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirebaseMessaging.getInstance().subscribeToTopic("podcast_oli").addOnSuccessListener {
            debug("subscribed")
